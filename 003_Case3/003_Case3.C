...
int main(int argc, char *argv[])
{
    ...
    Info << "Finished! Best to visualise the results by plotting p iso-contours with range (-10,10) and applying a glyph filter to the U field in Paraview." << nl << endl;
