...
int main(int argc, char *argv[])
{
    ...
    Pout << "cellNumber[processor=" << Pstream::myProcNo() 
         << "] = " << mesh.C().size() << endl;
    ...
    if (Pstream::master())
    {
        forAll(nInternalFaces,i)
            Info << "nInternalFaces[processor=" << i << "] = " << nInternalFaces[i]
                 << ", nBoundaryPatches[processor=" << i << "] = " << nBoundaries[i] << endl;
    }
    ...
    forAll(mesh.boundary(),patchI)
        Pout << "Patch = " << patchI << ", name = " << mesh.boundary()[patchI].name() << endl;
    ...
    forAll(mesh.boundary(),patchI)
    {
        ...
        if (isA<processorPolyPatch>(pp))
            Pout << "Patch = " << patchI << ", name = " << mesh.boundary()[patchI].name()
                 << "---> a processor boundary!" << endl;
    }
